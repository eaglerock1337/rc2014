...
void view_inside(struct time_machine* tm, struct player* p) {
    ...
    case ACTION_TWO:    p->view = VIEW_BREAKER; p->new_view = true;     break;
    case ACTION_THREE:  p->view = VIEW_COMPUTER; p->new_view = true;    break;
    case ACTION_FOUR:   p->view = VIEW_CONSOLE; p->new_view = true;     break;
